...
class CNgay 
{
    ...
    public:
        ...
        void setNgay(int ngay) { Ngay = ngay; }
        void setThang(int thang) { Thang = thang; }
        void setNam(int nam) { Nam = nam; }
...
class CNguoi
{
    ...
    public:
        ...
        string getDiaChiThuongTru() { return DiaChiThuongTru; }
        int getNamSinh() { return NamSinh; }

        void setHoTen(string hoten) { HoTen = hoten; }
        void setCMND(string cmnd) { CMND = cmnd; }
        void setDiaChiThuongTru(string diachi) { DiaChiThuongTru = diachi; }
...
class CDat
{
    ...
    public:
        ...
        string getSoGiayChungNhan() { return SoGiayChungNhan; }
        int getSoThuaDat() { return SoThuaDat; }
        int getSoBanDo() { return SoBanDo; }
        string getDiaChi() { return DiaChi; }
        double getDienTich() { return DienTich; }
        CNgay getNgay() { return NgayCap; }
        double getDonGiaThueTrenMetVuong() { return DonGiaThueTrenMetVuong; }

        void setSoGiayChungNhan(string sogiaychungnhan ) { SoGiayChungNhan = sogiaychungnhan; }
        void setSoThuaDat(int sothuadat) { SoThuaDat = sothuadat; }
        void setSoBanDo(int sobando) { SoBanDo = sobando; }
        void setDiaChi(string diachi) { DiaChi = diachi; }
        void setDienTich(double dientich) { DienTich = dientich; }
        void setNgay(CNgay ngaycap) { NgayCap = ngaycap; }
        void setDonGiaThueTrenMetVuong(double dongiathue) { DonGiaThueTrenMetVuong = dongiathue; }
